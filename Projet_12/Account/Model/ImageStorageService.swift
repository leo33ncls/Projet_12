...
// Class that manages the image Storage.
class ImageStorageService {
    ...
    /**
     ...
     - Parameters:
        - userId: The id of the user for which we want the background image data.
    ...
    /**
     ...
     - Parameters:
        - userId: The id of the user for which we want the image data.
